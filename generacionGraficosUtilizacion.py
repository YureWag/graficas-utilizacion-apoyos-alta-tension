...
def abrirModuloAsistenteEcuaciones():
    ...
    posicionX = ventanaPrincipal.winfo_x() + 500 # Pongo +500 para que en mi resolución (full HD) aparezca a la derecha de los valores insertados en ventana principal
